const icons = (() => {
    ...
    const iconPaths = {
        ...
        bellOff: '<path d="m13.73 21a2 2 0 0 1-3.46 0"/><path d="M18.63 13A17.89 17.89 0 0 1 18 8"/><path d="M6.26 6.26A5.86 5.86 0 0 0 6 8c0 7-3 9-3 9h14"/><path d="m21 21-18-18"/>', // 알림 끄기
        repeat: '<polyline points="17,1 21,5 17,9"/><path d="M21 5H9a4 4 0 0 0-4 4v6"/><polyline points="7,23 3,19 7,15"/><path d="M3 19h12a4 4 0 0 0 4-4V9"/>', // 반복
